<!-- Navbar -->
    <div class="col text-center p-0" id="nav-top" onclick="navScroll()"><img src="../../resources/images/icons/line.svg"></div>
    <nav class="navbar navbar-expand-md py-3" id="main-navbar" onclick="navScroll()">
